 ...
 * generated in the com.mycompany.bankws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOperationsByClientID_QNAME = new QName("http://bankws.mycompany.com/", "getOperationsByClientID");
    private final static QName _GetOperationsByClientIDResponse_QNAME = new QName("http://bankws.mycompany.com/", "getOperationsByClientIDResponse");
    private final static QName _GetOperationDetailsByID_QNAME = new QName("http://bankws.mycompany.com/", "getOperationDetailsByID");
    private final static QName _GetOperationDetailsByIDResponse_QNAME = new QName("http://bankws.mycompany.com/", "getOperationDetailsByIDResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mycompany.bankws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankws.mycompany.com/", name = "getOperationsByClientID")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankws.mycompany.com/", name = "getOperationsByClientIDResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankws.mycompany.com/", name = "getOperationDetailsByID")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankws.mycompany.com/", name = "getOperationDetailsByIDResponse")

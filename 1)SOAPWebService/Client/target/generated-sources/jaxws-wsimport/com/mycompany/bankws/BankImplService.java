 ...
 * 
 */
@WebServiceClient(name = "BankImplService", targetNamespace = "http://bankws.mycompany.com/", wsdlLocation = "http://localhost:8081/BankInterface?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKIMPLSERVICE_QNAME = new QName("http://bankws.mycompany.com/", "BankImplService");
    ...
    public BankInterface getBankImplPort() {
        return super.getPort(new QName("http://bankws.mycompany.com/", "BankImplPort"), BankInterface.class);
    }
    ...
    public BankInterface getBankImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://bankws.mycompany.com/", "BankImplPort"), BankInterface.class, features);
    }

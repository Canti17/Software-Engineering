 ...
 * 
 */
@WebServiceClient(name = "AAAWSImplService", targetNamespace = "http://aaaws.mycompany.com/", wsdlLocation = "http://localhost:8080/AAAWSInterface?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/AAAWSInterface?wsdl");
    ...
    public AAAWSInterface getAAAWSImplPort() {
        return super.getPort(new QName("http://aaaws.mycompany.com/", "AAAWSImplPort"), AAAWSInterface.class);
    }
    ...
    public AAAWSInterface getAAAWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://aaaws.mycompany.com/", "AAAWSImplPort"), AAAWSInterface.class, features);
    }

 ...
 * @author biar
 */
public class GestoreOrdini implements MessageListener{
    ...
    public GestoreOrdini(String user) {
        this.user = user;
        ...
        try {
            ...
            Logger.getLogger(GestoreOrdini.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
